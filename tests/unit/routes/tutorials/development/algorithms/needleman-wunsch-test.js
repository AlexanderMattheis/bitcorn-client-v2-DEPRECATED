...
qunit_1.module('Unit | Route | tutorials/development/algorithms/needleman-wunsch', function (hooks) {
    ember_qunit_1.setupTest(hooks);
    qunit_1.test('it exists', function (assert) {
        var route = this.owner.lookup('route:tutorials/development/algorithms/needleman-wunsch');
        assert.ok(route);
    });
});
